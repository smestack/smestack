...
description: 20-30 minute consultant-style interview that writes a "What I learned about you" business profile to workspace/business.md. The first thing every SME owner does after installing SmeStack. Triggers prescription-engine on completion.
---

# /business-intake — SmeStack consultant intake
...
12. **The one promise:** "If SmeStack could nail one specific thing for you — and only one — what should that thing be?"
...
> Generated by SmeStack /business-intake on YYYY-MM-DD.
...
## The one promise
{Q12 — the single most important thing SmeStack should nail for this owner}
